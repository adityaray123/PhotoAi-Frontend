...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.p className="text-center mx-w-xl mx-auto mt-5"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.6, duration: 0.8 }}
      >
        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia est
        consequatur et. Vel esse, dolor doloremque eaque corporis veritatis
        excepturi!
      </motion.p>
      ...
      <motion.p
        ...
        className="mt-2 text-neutral-600">Generated images from PhotoAi</motion.p>
    </motion.div>
  );
};
